        ...
        (
            ...
            <div className=" bg-white h-fit w-[90%] mx-auto rounded-xl mt-40 p-5">
                ...
                <ul className="flex flex-col justify-start">
                    <li className="py-5">
                    <span className={ pathname === "/" ? 'text-xl font-medium text-[#FFA800]' : "text-gray-900 text-xl font-medium"}>
                        <Link href={"/"}>
                        Home
                        </Link>
                    </span>
                    ...
                    <li className="py-5">
                    <span  className={ pathname === "/news" ? 'text-xl font-medium text-[#FFA800]' : " text-gray-900 text-xl font-medium"} >
                    <Link href={"/news"}>
                        News
                    </Link>
                    </span>
                    ...
                    <li className="py-5">
                    <span className={ pathname === "/FAQs" ? ' text-lg font-medium text-[#FFA800]': " text-gray-900 text-lg font-medium"}>
                    ...
                    <li className="py-5">
                    <span className={ pathname === "/about" ? 'text-xl font-medium text-[#FFA800]' : " text-gray-900 text-xl font-medium"}>
                    <Link href={"/about"}>
                       About Us
                    </Link>
                    </span>
         ...
         <header className={`font-inter w-[95%] mx-auto h-fit z-50  backdrop-blur-md bg-transparent`}>
            <nav className='flex flex-row md:flex-row-reverse mx-4 items-center justify-between md:justify-between font-mont h-20 font-medium'>
                <span className='hidden md:flex md:flex-row md:items-center'>
                    ...
                    <span  className={ pathname === "/news" ? 'text-lg mx-4 font-medium text-[#FFA800]' : "mx-4 text-gray-900 text-lg font-medium"} >
                    <Link href={"/news"}>
                        News
                    </Link>
                    </span>
                    <span className={ pathname === "/FAQs" ? ' mx-4 text-lg font-medium text-[#FFA800]': "mx-4 text-gray-900 text-lg font-medium"}>
                    <Link href={"https://uniuyo-guide.vercel.app/"}>
                       Map
                    </Link>
                    </span> 
                    <span className={ pathname === "/about" ? 'mx-4 text-lg font-medium text-[#FFA800]' : "mx-4 text-gray-900 text-lg font-medium"}>
                    <Link href={"/about"}>
                       About Us
                    </Link>
                    </span>
                ...
                <button className="block md:hidden" onClick={() => setDropDownVisible(!dropDownVisible)}>
